...
struct process
  ...
  main()
  {
    ...
    for(r=0;r<n;i++)
    {
      printf("Enter Process Number, Arrival Time and CPU Burst Time: \n");
    ...
    printf("\n*****************************");
    printf("\nProcesses Arrival Time CPU Burst Time Finish Time TAT WT nTAT");
    for(f=0;f<n;f++)
    {
    ...
    printf("\nAverage normalized TAT is %f", antat);
  getch();
  }
